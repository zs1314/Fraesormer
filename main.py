...
def get_args_parser():
    parser = argparse.ArgumentParser(
        'Freaormer training and evaluation script', add_help=False)
    """调参常用命令——汇总"""
    parser.add_argument('--batch-size', default=256, type=int)
    parser.add_argument('--epochs', default=300, type=int)
    # Model parameters
    parser.add_argument('--model', default='freasormer-b', type=str, metavar='MODEL',
    ...
    parser.add_argument('--data-path', default='/root/Food_data/UEC_Food-256_huafen', type=str,
                        help='dataset path')
    parser.add_argument('--data-set', default='UEC_Food-256', choices=['ETHZ_Food-101', 'UEC_Food-256', 'Vireo_Food-172', 'SuShi-50'],
                        type=str, help='dataset path')
    parser.add_argument('--output_dir', default=r'/root/Fraesormer/UEC_Food-256-result/',
                        help='path where to save, empty for no saving')
    parser.add_argument('--eval', action='store_true',
                        help='Perform evaluation only')


    parser.add_argument('--model-ema', default=True,action='store_true')
    parser.add_argument(
...
def main(args):
    ...
    args.output_dir=args.output_dir+'_'+args.model
    ...
    """Model """
    from model import Fraesormer
    print(f"Creating model: {args.model}")
    model = Fraesormer.fraesormer_t(num_classes=args.nb_classes)
    # model=Fraesormer.fraesormer_b(num_classes=args.nb_classes)
    # model = Fraesormer.fraesormer_l(num_classes=args.nb_classes)
    model.to('cuda')
    ...
    if args.eval:
        ...
        test_stats = evaluate(data_loader_test, model, 'cuda')
        print(
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        val_stats = evaluate(data_loader_val, model, 'cuda')
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        'Fraesormer training and evaluation script', parents=[get_args_parser()])
